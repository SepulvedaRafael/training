...
Dado o tipo de chá real e as respostas forneceidas, determinar o número de participantes que receberam a resposta correta.
...
Saída
A saída contém um inteiro representado o número de concorrentes que obtiveram a resposta correta.

...
No jogo, cada jogador recebe três cartas. As regras são simples:
    - Um trio (três cartas do mesmo valor) ganha de uma dupla (duas cartas de mesmo valor).
...
Note que o jogo pode não ter ganhador em muitas situações; nesses casos, as cartas distruídas são devolvidas ao baralho, que é embaralhado e uma nova partida é iniciada.
